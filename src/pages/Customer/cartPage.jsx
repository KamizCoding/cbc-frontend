...
export default function CartPage() {
    ...
    return (
        <div className="w-full min-h-screen flex flex-col">
            ...
            {/* Cart Section */}
            <div className="flex flex-col lg:flex-row items-center lg:items-start p-6 bg-primary flex-grow">
                ...
                {cart.length > 0 && (
                    <div className="w-full lg:w-1/3 max-w-md bg-accent text-dark rounded-lg shadow-lg p-5 ml-4 lg:sticky top-6 border border-gray-300">
                        ...
                        <button className="w-full text-center mt-6 px-5 py-3 bg-accent text-white text-lg font-medium rounded-md hover:bg-secondary transition-all duration-300 shadow-md" onClick={onCheckoutClicked}>
                            Proceed to Checkout
                        </button>
                    </div>
                )}
