...
export default function AdminProductsPage() {
    ...
    return (
        <div className="p-6 bg-lime-50 min-h-screen flex flex-col items-center relative">
            <Link to = {"/admin/products/addProducts"} className="absolute right-0 bottom-5 flex items-center gap-2 p-3 bg-lime-600 text-white rounded-lg shadow-md hover:bg-lime-700 hover:scale-105 hover:shadow-lg transition-transform duration-300 ease-in-out">
