                            ...
                            <tbody className="text-gray-800 text-sm font-medium divide-y divide-gray-200">
                                {orders.map((order, index) => (
                                    <tr key={order.orderId} className={`${index % 2 === 0 ? 'bg-lime-100' : 'bg-lime-200'} hover:bg-lime-300 transition duration-200`}>
                                        ...
                                        <td className="py-4 px-6 text-left capitalize">{order.status}</td>
                                        <td className="py-4 px-6 text-left">{new Date(order.date).toLocaleDateString()}</td>
                                        <td className="py-4 px-6 font-bold text-dark">LKR {calculateTotal(order.orderedItems).toFixed(2)}</td>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 px-4">
                    <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-3xl">
                        ...
                        <div className="mt-4 flex justify-between">
                            ...
                            <button className="bg-lime-600 text-white px-4 py-2 rounded-lg hover:bg-lime-700 transition-all" onClick={updateOrder}>
                                Save Changes
                            </button>
                        </div>
                    </div>
